    ...
    <div className="container">
        <div className="row">
            <div className="col-md-6">
                ...
                <p className="mb-2"><i className="fa fa-map-marker-alt me-3 address"></i>Emaar 105 sector central plaza CPM 53 SCO 1st floor the chandigarh realtors</p>
                    <p className="mb-2"><i className="fa fa-phone-alt me-3 address"></i>+91 8950801205</p>
